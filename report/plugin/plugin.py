...
class HTMLReport(object):
    ...
    def _generate_report(self, session):
        ...
        #                     label='unexpected passes')]  # modify by tang
        ...
        summary = [html.p(
            # '{0} tests ran in {1:.2f} seconds. '.format(  # modify by tang
            '{0} 个用例执行了 {1:.2f} 秒. '.format(
                numtests, suite_time_delta)),
            # html.p('(Un)check the boxes to filter the results.', # modify by tang
            html.p('勾选复选框筛选测试结果.',
                   class_='filter',
                   hidden='true')]
        ...
        results = [html.h2('测试结果'), html.table([html.thead(  #modify by tang
            html.tr(cells),
            html.tr([
        ...
        # body.extend([html.h2('Summary')] + summary_prefix  #modify by tang
        body.extend([html.h2('运行概况')] + summary_prefix
